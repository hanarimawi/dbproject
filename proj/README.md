...
- [ ] Add an email address to the `ADMINS` settings variable in `proj/proj/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `proj/proj/settings/production.py`
...
- Create a copy of ``proj/settings/local.py.example``:  
  `cp proj/settings/local.py.example proj/settings/local.py` (remembering you should replace `proj` with your project's name!).
